    ...
    <>
      ...
      <section>
        ...
        <div className="px-8 md:px-16 md:mx-auto md:text-md text-xs leading-loose">
          <p>{validatedAboutPage.field_mission_statement}</p>
        </div>
      </section>
      <section>
        <p className="text-xl md:mt-[10vh] mt-9 text-center md:text-left tracking-widest">
          WUNDER IN NUMBERS
        </p>
      ...
      <section className="md:mx-auto pb-10">
        <p className="text-xl md:mt-[10vh] mt-9 tracking-widest text-center md:text-left uppercase">
          Our Customers
        </p>
      ...
      <article className="md:mx-auto pb-[10em]">
        <div className="">
          <p className="text-xl pb-5 md:mt-[10vh] mt-2 tracking-widest uppercase text-center md:text-left">
            Testimonials
          </p>
          <div className="px-8 md:px-16 md:flex grid ss:grid-cols-3 gap-x-5 md:justify-around md:gap-x-10 mt-5 gap-y-5 ">
            {validatedAboutPage.field_testimonials.length > 0 &&
            Array.isArray(validatedAboutPage.field_testimonials) ? (
              validatedAboutPage.field_testimonials.map((testimonial) => (
                <div
                  key={testimonial.id}
                  className="bg-finnishwinter rounded-lg flex flex-col items-center pb-4"
                >
                  <Image
