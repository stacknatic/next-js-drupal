  ...
  return (
    <div>
      <div className="w-full flex items-center justify-center rounded-xl shadow-inherit ">
        <form
          className="mb-2 w-[75%] grid gap-6"
          onSubmit={handleSubmit(onSubmit, onErrors)}
        >
          <h1 className="mb-10 text-center pt-4 tracking-wide text-[2.5rem] font-bold my-10 text-primary-800">
            Leave us a message
          </h1>
          ...
          <div className="text-center pb-5">
            <button
              className="bg-primary-500 text-white px-[6rem] py-5 rounded-full"
              type="submit"
            >
              Send Message
            </button>
