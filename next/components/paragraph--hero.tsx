...
export function ParagraphHero({ paragraph }: { paragraph: HeroType }) {
  ...
  return (
    <section id="hero" className="flex sm:min-w-screen mb-2 sm:mb-6 sm:mt-0 sm:mx-auto sm:max-w-screen overflow-x-hidden sm:min-h-[100%] lg:min-h-[81vh] lg:mx-[-168px] mx-[-24px]">
