    ...
    <>
      ...
      <article className="md:relative grid md:grid-cols-1 md:gap-1 gap-2 px-4 md:px-16 ">
        <div className="my-4 grid grid-cols-1 content-start h-full rounded-md  overflow-hidden transition-all row-span-2">
          ...
          <div className="mt-6 md:ml-6 md:mt-[-50px] md:pt-4 md:shadow-2xl md:rounded-2xl z-30 md:bg-white md:w-[935px] md:px-8">
          ...
          <div className="md:absolute top-[400px] right-10 md:w-96 md:shadow-2xl md:rounded-2xl z-30 md:bg-white">
